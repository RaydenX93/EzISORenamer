...
FileChangeDir(@ScriptDir &"\")
		...
		Case 0 ;non c'è nessun file .iso. Magari sono tutte cartelle?
			...
			Else ;no, ci sono file sconosciti
				MsgBox(16, $prog_name, "You are trying to process files that this program cannot handle." & @CRLF & @CRLF & "To use the Drag n Drop feature, drag here" & @CRLF & "- iso files" & @CRLF & "OR" & @CRLF & "- directories.")
				Exit
			EndIf

		Case Else ;il coglione ha messo roba mischiata. Ferma tutto
			MsgBox(16, $prog_name, "It seems you have dragged some iso files together with others." & @CRLF & @CRLF & "To use the Drag n Drop feature, drag here" & @CRLF & "- iso files" & @CRLF & "OR" & @CRLF & "- directories.")
			Exit
