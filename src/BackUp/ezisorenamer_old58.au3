...
If $cmdline[0] <> 0 Then
	...
	Switch $cmdline[0]
		...
		Case Else ;non ho idea di quando possa accadere una cosa del genere
			MsgBox(16, $prog_name, "Unexpected command line." & @CRLF & @CRLF & "To use the Drag n Drop feature, drag here" & @CRLF & "- iso files" & @CRLF & "OR" & @CRLF & "- directories containing iso files")
			Exit
	EndSwitch
