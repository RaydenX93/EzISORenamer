...
If $cmdline[0] <> 0 Then
	...
	Switch $cmdline[0]
		...
		Case $iso + $empty + $unknown ;un mischione di tutto che non si può spiegare come
			MsgBox(16, 16, "You are trying to process files and/or folders that this program cannot handle." & @CRLF & @CRLF & "To use the Drag n Drop feature, drag here" & @CRLF & "- iso files" & @CRLF & "OR" & @CRLF & "- directories containing iso files.")
			Exit
		Case Else
